    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          >
            {/* Nombre */}
            <Field label="Nombre / Razón Social" icon={<User size={14} />}>
              <input
                name="nombre"
                value={form.nombre}
                required
                onChange={(e) => set("nombre", e.target.value)}
                placeholder="ej. Talleres Pérez S.A."
                disabled={saving}
                className={inputCls}
              />
            </Field>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field label="Tipo de Cliente" icon={<Building2 size={14} />}>
                <select
                  name="tipo"
                  value={form.tipo}
            ...
            {/* Ubicación */}
            <Field label="Ubicación / Dirección" icon={<MapPin size={14} />}>
              <input
                name="ubicacion"
